...
Mata Kuliah: Visualisasi Data (IFR309 - 3 SKS)
...
Dosen Pengampu: Mahendar Dwi Payana, S.ST., M.T. (NIDN: 1331108701)
"""
...
NIDN_DOSEN = "1331108701"

DOCX_MAIN = os.path.join(OUTPUT_DIR, "Kontrak_Kuliah_Visualisasi_Data_IFR309_Mahendar_Dwi_Payana.docx")
DOCX_LATEST = os.path.join(OUTPUT_DIR, "Kontrak_Kuliah_Visualisasi_Data_IFR309_Latest.docx")

PDF_MAIN = os.path.join(OUTPUT_DIR, "Kontrak_Kuliah_Visualisasi_Data_IFR309_Mahendar_Dwi_Payana.pdf")
PDF_LATEST = os.path.join(OUTPUT_DIR, "Kontrak_Kuliah_Visualisasi_Data_IFR309_Latest.pdf")
...
def build_docx_kontrak():
    print("-> Membangun Dokumen Word (.docx) Kontrak Kuliah Visualisasi Data...")
    doc = docx.Document()
    ...
    id_data = [
        ["1. Nama Mata Kuliah", "Visualisasi Data (Data Visualization)"],
        ["2. Kode Mata Kuliah / Bobot SKS", "IFR309 / 3 SKS (Teori: 2 SKS, Praktik: 1 SKS)"],
        ...
        ["5. Kurikulum / Rumpun MK", "Kurikulum 2023 (OBE) / Sains Data & Informatika Cerdas"],
        ["6. Semester / Periode Akademik", "Semester V (Lima) / 2026 Ganjil"],
        ["7. Nama Kelas / Sistem Kuliah", "Kelas A / Reguler"],
        ["8. Kapasitas Kelas / Jumlah Peserta", "60 Mahasiswa / 19 Mahasiswa"],
        ["9. Dosen Pengampu Utama", f"Mahendar Dwi Payana, S.ST., M.T. (NIDN: {NIDN_DOSEN})"],
        ["10. Ruang Perkuliahan & Praktikum", "Lab. Rekayasa Perangkat Lunak & Sains Data UUI"]
    ]
    ...
    add_body_p("Mata kuliah Visualisasi Data (IFR309) membekali mahasiswa S1 Informatika dengan keahlian strategis dalam mentransformasikan data mentah dan kompleks menjadi representasi visual yang komunikatif, interaktif, dan bernilai analitis tinggi. Di era Big Data dan kecerdasan artifisial, kemampuan menyajikan wawasan data (data storytelling), membangun dashboard Business Intelligence interaktif, serta merancang visualisasi model Machine Learning merupakan kompetensi kelas industri yang sangat dicari untuk mendukung pengambilan keputusan berbasis data (data-driven decision making).")

    # 3. DESKRIPSI SINGKAT MATA KULIAH
    add_sec_heading("III.", "DESKRIPSI MATA KULIAH")
    add_body_p("Mata kuliah ini membahas teori persepsi visual manusia (Teori Gestalt & Atribut Pra-atentif), prinsip desain grafis analitis Edward Tufte (Data-Ink Ratio, Lie Factor, Chartjunk) dan Tamara Munzner, eksplorasi data statistik (EDA) menggunakan Python (Pandas, Matplotlib, Seaborn), visualisasi relasi multivariat, visualisasi data deret waktu (Time Series), pemetaan geospasial interaktif (Folium & GeoPandas), visualisasi interaktif web-ready (Plotly), visualisasi evaluasi model Machine Learning dan reduksi dimensi (PCA & t-SNE), narasi data bisnis (Data Storytelling), hingga pembangunan dan deployment dashboard analitik berbasis web menggunakan Streamlit.")

    # 4. CAPAIAN PEMBELAJARAN (CPL & CPMK)
    add_sec_heading("IV.", "CAPAIAN PEMBELAJARAN LULUSAN & MATA KULIAH (CPL & CPMK)")
    add_bullet_p("CPL01 (Pengetahuan Teoretis)", "Memiliki pengetahuan komprehensif tentang teori grafika, persepsi visual manusia, semiotika data, teori warna, dan prinsip efisiensi grafis Tufte.")
    add_bullet_p("CPL03 (Keterampilan Kerja Umum)", "Mampu merumuskan persoalan eksplorasi data, melakukan data wrangling, serta memilih encoding visual yang tepat.")
    add_bullet_p("CPL04 (Keterampilan Khusus)", "Mampu merancang, membangun, dan menyajikan solusi visualisasi interaktif, peta geospasial, serta dashboard analitik berbasis web.")
    add_bullet_p("CPL08 (Sikap & Etika)", "Mematuhi etika integritas data visual (Graphical Integrity), bebas manipulasi bias, dan anti-plagiarisme.")

    add_body_p("Capaian Pembelajaran Mata Kuliah (CPMK):", bold_prefix="Capaian Spesifik:")
    add_bullet_p("CPMK-1", "Menguasai teori persepsi visual, prinsip desain grafis analitis (Tufte, Gestalt, Munzner), dan semiotika visual data.")
    add_bullet_p("CPMK-2", "Mampu mengolah, mentransformasi, dan memvisualisasikan data statistik serta distribusi menggunakan Python (Matplotlib dan Seaborn).")
    add_bullet_p("CPMK-3", "Mampu membangun visualisasi interaktif, eksplorasi multivariat, pemetaan geospasial, dan dashboard berbasis web (Plotly, Folium, Streamlit).")
    add_bullet_p("CPMK-4", "Mampu menyusun narasi data (Data Storytelling), memvisualisasikan model Machine Learning, dan mempublikasikan dashboard proyek capstone terpadu.")
    ...
    rps_data = [
        ["1", "Memahami epistemologi visualisasi data", "Kontrak Kuliah, Sejarah Visualisasi, Model Komunikasi Data", "Kuliah Interaktif & Diskusi", "Aktivitas Partisipatif"],
        ["2", "Mampu menganalisis persepsi visual", "Psikologi Persepsi Visual Manusia, Atribut Pra-atentif, Gestalt", "Kuliah & Simulasi Visual", "Tugas Praktikum 1"],
        ["3", "Mampu menerapkan prinsip Edward Tufte", "Prinsip Tufte: Data-Ink Ratio, Chartjunk, Lie Factor, Integrity", "Bedah Kasus Misleading Chart", "Tugas Praktikum 2"],
        ["4", "Mampu melakukan data wrangling & EDA", "Data Cleaning, Aggregation, Handling Missing Values, Pandas", "Live Coding di Lab", "Tugas Praktikum 3"],
        ["5", "Mampu membuat plot OO Matplotlib", "Arsitektur Object-Oriented Matplotlib (Figure, Axes), Subplots", "Praktikum Terbimbing", "Quiz 1"],
        ["6", "Mampu memvisualisasikan distribusi data", "Visualisasi Statistik Seaborn: Histogram, KDE, Box, Violin Plot", "Praktikum Komparatif", "Tugas Praktikum 4"],
        ["7", "Mampu menganalisis relasi multivariat", "Scatter Plot, Heatmap Korelasi, Pairplot, Treemap, Sankey", "Praktikum Intensif Lab", "Tugas Praktikum 5"],
        ["8", "EVALUASI CAPAIAN PERTEMUAN 1 s.d. 7", "UJIAN TENGAH SEMESTER (UTS) - TEORI DESAIN & LIVE CODING EDA", "Ujian Tertulis & Praktik Lab", "UTS (30%)"],
        ["9", "Mampu membuat grafik interaktif Plotly", "Plotly Express, Graph Objects, Custom Hover Tooltips, Zoom", "Collaborative Coding", "Tugas Praktikum 6"],
        ["10", "Mampu memvisualisasikan data geospasial", "Sistem Koordinat GPS, GeoJSON, Choropleth, Folium, GeoPandas", "Praktikum GIS Komputasi", "Tugas Praktikum 7"],
        ["11", "Mampu menganalisis tren deret waktu", "Time Series, Candlestick, Moving Average, Tren Musiman", "Studi Kasus Finansial/IoT", "Quiz 2"],
        ["12", "Mampu memvisualisasikan model ML & AI", "Visualisasi Model ML: Confusion Matrix, ROC-AUC, PCA, t-SNE", "Eksperimen Model AI", "Tugas Praktikum 8"],
        ["13", "Mampu membangun web apps Streamlit", "Arsitektur Streamlit, Widget Input, Caching, Live Deployment", "Project-Based Learning", "Tugas Praktikum 9"],
        ["14", "Mampu menyusun data storytelling bisnis", "Data Storytelling, Mengurangi Beban Kognitif, Executive Summary", "Workshop Presentasi", "Aktivitas Partisipatif"],
        ["15", "Mampu merekayasa capstone dashboard", "Pengembangan Proyek Capstone: Dashboard Analitik Interaktif", "PjBL & Asistensi Terbimbing", "Asistensi Proyek"],
        ["16", "EVALUASI CAPAIAN KOMPREHENSIF PROYEK", "UJIAN AKHIR SEMESTER (UAS) - PRESENTASI & DEMO DASHBOARD", "Demo & Evaluasi Capstone", "UAS (40%)"]
    ]
    ...
    add_bullet_p("4. Fasilitas & Praktikum Lab", "Setiap mahasiswa wajib membawa laptop kerja pribadi yang telah terinstal Python 3.10+, Jupyter Notebook / VS Code, Pandas, Matplotlib, Seaborn, Plotly, dan Streamlit. Dilarang merusak, mengubah konfigurasi jaringan lab, atau mengotori ruang laboratorium.")
    add_bullet_p("5. Penyerahan Tugas & Sanksi Keterlambatan", "Tugas mandiri, analisis grafik, dan dashboard wajib diunggah tepat waktu melalui LMS Siakad UUI / Repositori GitHub resmi kelas. Keterlambatan pengumpulan tugas dikenakan penalti pemotongan nilai sebesar 10% per hari (maksimal toleransi 3 hari).")
    add_bullet_p("6. Integritas Akademik & Anti-Plagiarisme", "Kecurangan akademik dalam bentuk apa pun (plagiarisme visualisasi/analisis data, fabrikasi data visual/Lie Factor, menyalin dashboard teman, atau kecurangan saat ujian) dikenakan sanksi tegas pembatalan nilai (Nilai E otomatis untuk mata kuliah ini) dan dilaporkan ke Komite Disiplin Universitas Ubudiyah Indonesia.")

    # 8. PUSTAKA & REFERENSI
    add_sec_heading("VIII.", "SUMBER BELAJAR & DAFTAR PUSTAKA")
    add_bullet_p("Buku Ajar Utama", "Payana, M. D., Yusian TB, D. R., & Wibawa, M. B. (2026). Buku Ajar Visualisasi Data dan Eksplorasi Analitik Berbasis Python. Universitas Ubudiyah Indonesia Press.")
    add_bullet_p("Teori Desain Grafis", "Tufte, E. R. (2001). The Visual Display of Quantitative Information (2nd ed.). Graphics Press.")
    add_bullet_p("Framework Analitik", "Munzner, T. (2014). Visualization Analysis and Design. CRC Press.")
    add_bullet_p("Storytelling Data", "Knaflic, C. N. (2015). Storytelling with Data: A Data Visualization Guide for Business Professionals. John Wiley & Sons.")
    ...
    r = p_dt.add_run(f"Dosen Pengampu Mata Kuliah,\n\n\n\n\n( Mahendar Dwi Payana, S.ST., M.T. )\nNIDN. {NIDN_DOSEN}")
    r.font.name = "Calibri"
    r.font.size = Pt(10.0)
    r.bold = True
...
class SimplePDF:
    ...
    def new_page(self):
        ...
        self.draw_text("Universitas Ubudiyah Indonesia | Kontrak Perkuliahan Visualisasi Data (IFR309)", 40, 810, font="F3", size=8, color=(0.4, 0.45, 0.5))
...
def build_pdf_document():
    print("-> Membangun Dokumen PDF Kontrak Kuliah Visualisasi Data...")
    pdf = SimplePDF()
    ...
    id_rows = [
        ("Nama Mata Kuliah", "Visualisasi Data (Data Visualization)", "Kode MK / SKS", "IFR309 / 3 SKS (T=2, P=1)"),
        ("Program Studi / Jenjang", "S1 - Informatika / Sarjana (S1)", "Semester / Periode", "Semester V / 2026 Ganjil"),
        ("Fakultas / Universitas", "Fakultas Sains dan Teknologi / UUI", "Nama Kelas / Sistem", "Kelas A / Reguler"),
        ("Kurikulum / Rumpun", "Kurikulum 2023 (OBE) / Sains Data", "Kapasitas / Peserta", "60 Mahasiswa / 19 Mahasiswa"),
        ("Dosen Pengampu Utama", f"Mahendar Dwi Payana, S.ST., M.T.", "NIDN / Ruangan", f"NIDN: {NIDN_DOSEN} / Lab. Sains Data")
    ]
    ...
    y_sec -= 16
    pdf.draw_text("Mata kuliah Visualisasi Data (IFR309) membekali mahasiswa S1 Informatika dengan keahlian strategis dalam mentransformasikan", 40, y_sec, font="F1", size=8.5, color=(0.1, 0.15, 0.2))
    y_sec -= 11
    pdf.draw_text("data mentah menjadi representasi visual komunikatif, interaktif, dan bernilai analitis tinggi. Mahasiswa mempelajari teori Gestalt,", 40, y_sec, font="F1", size=8.5, color=(0.1, 0.15, 0.2))
    y_sec -= 11
    pdf.draw_text("prinsip desain grafis Tufte & Munzner, EDA dengan Pandas, Matplotlib, Seaborn, grafik interaktif Plotly, geospasial Folium,", 40, y_sec, font="F1", size=8.5, color=(0.1, 0.15, 0.2))
    y_sec -= 11
    pdf.draw_text("visualisasi model AI (PCA/t-SNE), narasi data (Storytelling), dan pembangunan web dashboard interaktif dengan Streamlit.", 40, y_sec, font="F1", size=8.5, color=(0.1, 0.15, 0.2))
    ...
    y_sec -= 15
    cpls = [
        ("CPL01 (Pengetahuan Grafika)", "Menguasai teori grafika, persepsi visual manusia (Gestalt), semiotika, dan efisiensi grafis Tufte."),
        ("CPL03 (Keterampilan Kerja)", "Mampu merumuskan persoalan eksplorasi data, wrangling, dan memilih encoding visual tepat."),
        ("CPL04 (Keahlian Khusus)", "Mampu merancang, membangun visualisasi interaktif, peta geospasial, dan web dashboard."),
        ("CPL08 (Sikap & Etika)", "Menjunjung etika integritas data visual (Graphical Integrity) dan bebas bias manipulasi.")
    ]
    ...
    y_sec -= 4
    cpmks = [
        ("CPMK-1: Teori Persepsi Visual", "Menguasai teori persepsi visual, prinsip desain grafis analitis (Tufte, Gestalt, Munzner)."),
        ("CPMK-2: Plot Statistik Python", "Mampu mengolah data dan memvisualisasikan distribusi statistik dengan Matplotlib & Seaborn."),
        ("CPMK-3: Interaktif & Geospasial", "Mampu membangun visualisasi interaktif, multivariat, peta Folium, dan web apps Streamlit."),
        ("CPMK-4: Storytelling & Capstone", "Mampu menyusun narasi data bisnis, memvisualisasikan model Machine Learning, dan Capstone.")
    ]
    ...
    rps_pdf_rows = [
        ("1", "Memahami epistemologi visualisasi data", "Kontrak Kuliah, Sejarah Visualisasi, Model Komunikasi Data", "Ceramah & Diskusi", "Partisipatif"),
        ("2", "Mampu menganalisis persepsi visual", "Psikologi Persepsi Visual Manusia, Atribut Pra-atentif, Gestalt", "Kuliah & Simulasi", "Tugas 1"),
        ("3", "Mampu menerapkan prinsip Edward Tufte", "Prinsip Tufte: Data-Ink Ratio, Chartjunk, Lie Factor, Integrity", "Bedah Kasus Grafik", "Tugas 2"),
        ("4", "Mampu melakukan data wrangling & EDA", "Data Cleaning, Aggregation, Handling Missing Values, Pandas", "Live Coding Lab", "Tugas 3"),
        ("5", "Mampu membuat plot OO Matplotlib", "Arsitektur Object-Oriented Matplotlib (Figure, Axes), Subplots", "Praktikum Lab", "Quiz 1"),
        ("6", "Mampu memvisualisasikan distribusi data", "Visualisasi Statistik Seaborn: Histogram, KDE, Box, Violin Plot", "Praktikum Komparatif", "Tugas 4"),
        ("7", "Mampu menganalisis relasi multivariat", "Scatter Plot, Heatmap Korelasi, Pairplot, Treemap, Sankey", "Praktikum Intensif", "Tugas 5"),
        ("8", "EVALUASI CAPAIAN PERTEMUAN 1 s.d. 7", "UJIAN TENGAH SEMESTER (UTS) - TEORI DESAIN & LIVE CODING EDA", "Ujian Lab Terjadwal", "UTS (30%)"),
        ("9", "Mampu membuat grafik interaktif Plotly", "Plotly Express, Graph Objects, Custom Hover Tooltips, Zoom", "Collaborative Coding", "Tugas 6"),
        ("10", "Mampu memvisualisasikan data geospasial", "Sistem Koordinat GPS, GeoJSON, Choropleth, Folium, GeoPandas", "Praktik GIS Komputasi", "Tugas 7"),
        ("11", "Mampu menganalisis tren deret waktu", "Time Series, Candlestick, Moving Average, Tren Musiman", "Studi Kasus Finansial", "Quiz 2"),
        ("12", "Mampu memvisualisasikan model ML & AI", "Visualisasi Model ML: Confusion Matrix, ROC-AUC, PCA, t-SNE", "Eksperimen Model AI", "Tugas 8"),
        ("13", "Mampu membangun web apps Streamlit", "Arsitektur Streamlit, Widget Input, Caching, Live Deployment", "Project-Based Lab", "Tugas 9"),
        ("14", "Mampu menyusun data storytelling bisnis", "Data Storytelling, Mengurangi Beban Kognitif, Executive Summary", "Workshop Presentasi", "Partisipatif"),
        ("15", "Mampu merekayasa capstone dashboard", "Pengembangan Proyek Capstone: Dashboard Analitik Interaktif", "PjBL & Asistensi", "Asistensi"),
        ("16", "EVALUASI CAPAIAN KOMPREHENSIF PROYEK", "UJIAN AKHIR SEMESTER (UAS) - PRESENTASI & DEMO DASHBOARD", "Demo & Uji Dashboard", "UAS (40%)")
    ]
    ...
    rules = [
        ...
        ("3. Etika & Perlengkapan", "Berbusana rapi, sopan, berkerah, bersepatu. Membawa laptop dengan Python, Jupyter, & Streamlit."),
        ("4. Sanksi Plagiarisme", "Kecurangan akademik / manipulasi visual data (Lie Factor) berakibat Nilai E otomatis.")
    ]
    ...
    pdf.draw_text(f"NIDN. {NIDN_DOSEN}", 340, y_sec, font="F1", size=7.5, color=(0.4, 0.45, 0.5))
