...
| **3** | ⚡ **Efisiensi Struktur Data & Algoritma** | **25 Poin** | • Ketepatan implementasi algoritma pencarian (**Binary Search $O(\log n)$**)<br>• Ketepatan implementasi algoritma pengurutan (**Sorting $O(n^2)$ / $O(n \log n)$**)<br>• Pemahaman analisis kompleksitas Big-O pada alur komputasi |
...
2. **Kalkulasi Modular (Pass by Reference):**
   ...
   >
   > *Standar Huruf Mutu:* A ($\ge 85$), B ($70 - 84$), C ($55 - 69$), D ($40 - 54$), E ($< 40$).
   :::
